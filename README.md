...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-24 01:57`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e6702925-62e3-42f2-995a-ece51f85def6.git
$ cd e6702925-62e3-42f2-995a-ece51f85def6
```
